...
class OAuthService {
  constructor(private client: ReturnType<typeof axios.create>) {
    debugLog("[OAuth] Initialized with baseURL:", ENV.oAuthServerUrl);
...
class SDKServer {
  ...
  async authenticateRequest(req: Request): Promise<User> {
    ...
    if (!session) {
      throw ForbiddenError("Credenciais inválidas ou expiradas");
    }
    ...
    if (!user.isEmailVerified) {
      throw ForbiddenError("Conta não verificada. Por favor, confirme seu e-mail.");
    }
