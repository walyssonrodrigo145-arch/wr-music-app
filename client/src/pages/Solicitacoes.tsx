  ...
  return (
    <div className="space-y-8 pb-10">
      <div>
        ...
        <p className="text-muted-foreground font-medium mt-1">Gerencie pedidos de reagendamento e outras solicitações dos alunos.</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-32 bg-card/30 rounded-[3rem] border-2 border-dashed border-border/50">
            ...
            <p className="text-sm text-muted-foreground/60 font-medium mt-2">Nenhuma solicitação pendente no momento.</p>
          </div>
        ) : (
        ...
        <CardContent className="p-6 flex items-start gap-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-amber-600/80 font-medium leading-relaxed">
              Ao aprovar uma solicitação, o status será atualizado para o aluno. 
              Lembre-se de acessar o módulo de <strong>Aulas</strong> para efetivar a alteração do horário na agenda oficial.
            </p>
          </div>
        </CardContent>
      </Card>
